...
//        parseLocaleData.clear();
    ...
    public boolean isOlder(test.TestPersonWoman woman) {
    ...
    @Test(description = "This is check if setName and getName methods works for TestClassWoman class", dataProviderClass = DataProviders.class, dataProvider = "setName test data")
    ...
    @Test(description = "This is check if setLastname and getLastname methods works for TestClassWoman class",  dataProviderClass = DataProviders.class, dataProvider = "setLastname test data")
    ...
    @Test(description = "This is check if setAge and getAge methods works for TestClassWoman class",  dataProviderClass = DataProviders.class, dataProvider = "setAge test data")
    @Parameters({"womanLastname", "lastname"})
    ...
    @Test(description = "this is check if setIsBlond return isBlond", invocationCount = 5, dataProviderClass = DataProviders.class, dataProvider = "testIsBlond test data")
    ...
    @Test(description = "this is check if setNumberOfChildren and getNumberOfChildren works", timeOut = 6000, dataProviderClass = DataProviders.class, dataProvider = "setNumberOfChildren test data")
    ...
    @Test(description = "this is check if setIsRetired snd setAge works for class Woman", dataProviderClass = DataProviders.class, dataProvider = "setIsRetired test data")
    ...
    @Test(description = "this is check if getCurrentWeight, getLostWeight and setCurrentWeight works for class Woman", dataProviderClass = DataProviders.class, dataProvider = "getLostweight test data")
