...
public class Module {
    ...
    public static void main(String[] args) {
        ...
        } catch (InvalidPaymentAmountException e41) {
            System.out.println("ProcessPayment3 failed. Exception3.1: " + e41.getMessage());
        }
        ...
        } catch (InvalidPaymentCurrencyException e51) {
            System.out.println("ProcessPayment3 failed. Exception5.1: " + e51.getMessage());
        }
        ...
        try {
        ...
        } catch ( InvalidPaymentAmountException e1) {
            ...
            System.out.println("ProcessPayment6 failed. Exception2.1: Connection with bank has interrupted. " + e11.getMessage());
        } catch (InvalidPaymentCurrencyException e12) {
            System.out.println("ProcessPayment6 failed. Exception2.2: Connection with bank has interrupted. " + e12.getMessage());
        }
    }
}
