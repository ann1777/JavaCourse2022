...
//        assert departmentFld.getText().equals("Hogwarts magic");
        ...
        // checks that the entry has been changed
        WebElement fieldHasBeenChanged = driver.findElement(By.xpath("//*[text()='Garry']"));
        Assert.assertEquals(fieldHasBeenChanged.getText(), "Garry", "New entry has not been added to the users table");
    }
}
