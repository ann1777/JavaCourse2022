...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n~~~~~~~~~~~~");
        System.out.println("woman1: " + woman1.name + " " + woman1.lastname);
        System.out.println("man1: " + man1.name + " " + man1.lastname);
        woman1.registerPartnership(man1.lastname);
        System.out.println("After wedding " + woman1.name + " " + "changed her lastname for " + woman1.lastname);
        System.out.println("woman1: " + woman1.getName() + " " + woman1.getLastname());
        woman1.deregisterPartnership(true, "Loboda");
        System.out.println("But in case of the diworce with Ivan, " + woman1.name + " will " +
        ...
        System.out.println("After getting relationship with " + man2.name + ", " + man1.name + " " + "changed his lastname" + " " + "for " + man2.lastname);
        System.out.println("man1: " + man1.getName() + " " + man1.getLastname());
        man1.deregisterPartnership(true, "Pidubniy");
        System.out.println("man1: " + man1.getName() + " " + man1.getLastname());
