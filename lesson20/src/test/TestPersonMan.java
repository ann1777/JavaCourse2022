...
//    private static final Man man2 = new Man("Stepan", "Bandera", 29, true, false, 780000.00);
    ...
    @Test(description = "this is check if isRetired works for class Woman", dataProviderClass = DataProviders.class, dataProvider = "isRetired test data")
    ...
    @Test(description = "this is check if setGrossSalary and getGrossSalary works", dataProviderClass = DataProviders.class, dataProvider = "setGrossSalary test data")
    ...
    @Test(description = "this is check if setPartnerMale works", dataProviderClass = DataProviders.class, dataProvider = "setPartnerMale test data")
    ...
    @Test(description = "this is check if isSmoking works", dataProviderClass = DataProviders.class, dataProvider = "isThisSmoking test data")
