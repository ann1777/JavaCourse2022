...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println(man1.name +" "+ man1.lastname +"' gross salary was "+ man1.grossSalary);
        System.out.println(man2.name +" "+ man2.lastname +"' age is "+ man2.age);
        man1.setGrossSalary(0);
        man1.isSmoking();
        ...
        woman1.setIsBlond(false);
        woman1.setLostWeight(3.5);
        woman2.setNumberOfChildren(1);
        System.out.println(man1.name +" "+ man1.lastname +" lost his job, so his salary is "+ man1.grossSalary+ " now.");
        ...
        System.out.println("man1 is still: "+man1.name+" "+man1.lastname);
